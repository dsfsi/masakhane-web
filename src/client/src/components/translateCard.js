        ...
        <Modal.Header closeButton style={{ backgroundColor: "#F2F0E9" }}>
          <Col style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: 11, color: "gray" }}>
              We appreciate your feedback and your contribution will help make
              our translation better.
            </p>
          </Col>
        </Modal.Header>
        <Modal.Body>
